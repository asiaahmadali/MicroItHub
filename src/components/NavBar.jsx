...
function NavBar() {
  ...
  return (
    <>
      <nav className="flex h-[120px] w-full top-0 left-0 bg-blue-950 shadow-lg relative">
  <div className="bg-white flex items-center justify-center p-[60px] relative" style={{ backgroundImage: "url('/images/logo-bg.svg')" }}>
    <img className="h-[70px] w-[200px]" src="./images/MicroLogo.png" alt="logo" />
    {/* Diagonal cut */}
    <div className="absolute top-0 right-[-20px] h-full w-[40px] bg-blue-950 transform -skew-x-12"></div>
  </div>
