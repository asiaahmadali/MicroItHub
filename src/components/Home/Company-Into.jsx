...
{
    return <>
      <div className="flex p-[50px] items-center gap-[50px]">
              {/* img div */}
              <div className="w-1/2">
              ...
              <p className="text-blue-500 font-semibold text-[18px] flex items-center"> WHO WE ARE<span className="w-12 h-[2px] bg-blue-500 ml-2"></span> {/* Blue line */}</p>
                    <h1 className="text-4xl leading-[45px] font-bold">We are developing innovative, high-performance  <span className="text-blue-600 ">Software solutions</span> </h1>
                    <p className="text-gray-500 text-[18px] ">Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
