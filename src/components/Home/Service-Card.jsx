...
function Servicecard(Props) {
  return (
    <>
      <div className="w-[300px] flex flex-col gap-[20px] p-[25px] shadow-lg bg-white rounded-tl-lg rounded-br-[50px] rounded-bl-lg border-t-4 border-blue-400 relative group overflow-hidden">
        
        {/* Top blue line */}
        <h1 className="text-blue-950 text-2xl font-semibold group-hover:text-white transition-colors duration-300 z-10">{Props.head}</h1>
        
        {/* Description */}
        <p className="text-gray-400 text-[18px] mb-[60px] group-hover:text-white transition-colors duration-300 z-10">{Props.para}</p>
