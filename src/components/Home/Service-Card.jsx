...
function Servicecard(Props) {
  return (
    <>
      <div data-aos="fade-up" className="md:w-[300px] md:m-[2px] m-[20px] h-auto md:h-[300px] w-auto flex flex-col gap-[20px] p-[15px] md:p-[25px] shadow-lg bg-white rounded-tl-lg rounded-br-[50px] rounded-bl-lg border-t-4 border-blue-400 relative group overflow-hidden">
