      ...
      <div className='md:p-[50px] p-[20px] mt-[40px]'>
        <div className="flex justify-between md:flex-row flex-col gap-[20px]">
          <div>
            ...
            <h1 className="md:text-3xl text-2xl leading-[30px] md:leading-[40px] w-[auto] md:w-[500px] text-blue-950 font-bold">
          ...
          <div className="flex gap-[20px]">
               <div className="p-[20px] md:w-[170px] w-[100px] h-[100px] gap-[5px] md:h-[170px] flex flex-col rounded-full border border-blue-500 items-center justify-center ">
               ...
               <div className="p-[10px] md:w-[170px] w-[100px] h-[100px] gap-[5px] md:h-[170px] flex flex-col rounded-full border border-blue-500 items-center justify-center ">
