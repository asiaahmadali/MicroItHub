    ...
    <>
      <div>
        <div className="flex justify-betw">
          <div>
            <p className="text-blue-500 font-semibold text-[16px]">WHY CHOOSE US</p>
            <h1 className="text-4xl leading-[50px] w-[500px] text-blue-950 font-bold">
          ...
          <div className="flex">
            ...
            <div className="relative flex flex-col items-center justify-center">
              ...
              <div className="absolute p-[60px] flex flex-col items-center justify-center m-[20px] w-full h-full">
